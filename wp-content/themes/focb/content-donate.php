<form id="donation" name="_xclick" action="https://www.paypal.com/cgi-bin/webscr" method="post" target="new">
  <div>
    ...
    <label for="amount">Enter Donation Amount</label><br>
    <span id="dollar">$</span><input type="text" name="amount" placeholder="00.00" id="amount" autocomplete="off">
    <input type="submit" name="submit" value="Submit & Process My Donation">
  </div>
</form>